...
os.makedirs('test_cattle_weight/grayscale/maskrcnn', exist_ok=True)
...
try:
    while True:
        ...
        if save_gray:
            cv2.imwrite(f'test_cattle_weight/grayscale/maskrcnn/gray_{frame_count:05d}.png', frame_gray)
        frame_count += 1
